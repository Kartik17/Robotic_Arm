...
weights_1 = np.matrix(weights(size = (input_layers,hidden_layers_1))) #1x20
bias_1 = np.matrix(biases(size = (1,hidden_layers_1))) #1x20
weights_2 = np.matrix(weights(size = (hidden_layers_1,hidden_layers_2))) #20x20
...
while error > threshold and epoch<200000:
	epoch +=1
	...
	#print(activated_layer_1.shape,activated_layer_2.shape,predicted_y.shape)
	...
	#print(dweights_3.shape,dweights_2.shape,dweights_1.shape, dbias_3.shape, dbias_2.shape, dbias_1.shape)
